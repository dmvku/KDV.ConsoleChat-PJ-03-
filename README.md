...
08.03.2025
Добавлен предиктивный ввод - реализован через префиксное дерево поиска.
Новые возможности:
Загрузить словарь;
Сохранить словарь;
Начать с пустым словарём;
Новые слова добавляются в префиксное дерево. 

16.03.2025
Добавлен метод удаления пользователя - сообщения от удаленных пользователей сохраняются,
удаленные пользователи в сообщениях чата отображаются как "deleted".
Для хранения класса User используется контейнер std::list.
Пароль хранится в зашифрованном виде - стандарт sha1.
Оптимизирован код.
