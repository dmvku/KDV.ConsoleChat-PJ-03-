...
Два класса (User и Message) для создания обЪектов соответствующих типов с реализованными конструкторами, деструкторами, геттерами и сеттерами.
Массив объектов реализован на шаблонном классе vector стандартной библиотеки. 
