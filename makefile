...
server : $(MAIN).o $(LIB)
	g++ $(STD) -o $@ $(MAIN).o -pthread -L. lib$(LIB) $(LIBSQL)

$(MAIN).o : $(MAIN).cpp
	g++ $(STD) -o $@ $(MAIN).cpp -c

$(LIB) : chat.o user.o socket.o server_config.o DB_config.o database.o logger.o
	ar rc lib$(LIB) chat.o user.o socket.o server_config.o DB_config.o database.o logger.o
